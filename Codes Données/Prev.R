...
dataPrev_Printemps2025 <- dataPrev
dataPrev2_Printemps2025 <- dataPrev2

dataPrev <- dataPrev_Printemps2025 %>%
  filter(Fecha == as.Date("2025-04-01")) %>%
  bind_rows(
    mutate(., Fecha = as.Date("2026-01-01")),
    mutate(., Fecha = as.Date("2026-04-01"))
  ) %>%
  bind_rows(dataPrev_Printemps2025) %>%
  arrange(Fecha)

dataPrev2 <- dataPrev2_Printemps2025 %>%
  filter(Fecha == as.Date("2025-04-01")) %>%
  bind_rows(
    mutate(., Fecha = as.Date("2026-01-01")),
    mutate(., Fecha = as.Date("2026-04-01"))
  ) %>%
  bind_rows(dataPrev2_Printemps2025) %>%
  arrange(Fecha)
